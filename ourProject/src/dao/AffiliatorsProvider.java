...
public class AffiliatorsProvider {
	...
	private IAffiliateCompany viglinks = new AffiliateCompany("vigLinks","http://redirect.viglink.com?key="+ TemplatePlaceHolderResolver.SUBSCRIBER_KEY_PLACE_HOLDER +"&out="+ TemplatePlaceHolderResolver.DESTINATION_URL_PLACE_HOLDER, RedirectResolver.TemplatePlaceHolders);
